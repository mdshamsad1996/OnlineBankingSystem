...
public class home_loan extends HttpServlet {
    ...
    try
        {
            ...
            String id=null;
            String q1="select * from home_loan_id";
            ...
            if(rs.next())
            {
                ...
                id="CC"+no;
               // pw1.println(id);
                String q2="insert into home_loan values('"+nm1+"','"+nm2+"','"+nm3+"','"+nm4+"','"+nm5+"','"+nm6+"','"+nm7+"','"+nm8+"','"+nm9+"','"+nm10+"','"+nm11+"','"+nm12+"','"+id+"','no')";
                //pw1.println(q2);
                ...
                if(x>0)
                {
                    ...
                    no1++;
                    String q3="update home_loan_id set id='"+no1+"'";
                    //pw1.println(q3);
                    int x1=stmt.executeUpdate(q3);
                     ...
                     if(x1>0)
                     {
                      ...
                      pw1.println("<br><a href=\"status_home_loan.html\">Check status for approval</a>");
