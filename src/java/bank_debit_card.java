...
public class bank_debit_card extends HttpServlet {
    ...
    try
        {
            ...
            Statement stmt=con.createStatement();//creating statemnet which is actually required to execute query..
            String id=null;
            String q1="select * from debit_id";
            ...
            if(rs.next())
            {
                ...
                id="CC"+no;
               // pw1.println(id);
                String q2="insert into debit_card values('"+nm1+"','"+nm2+"','"+nm3+"','"+nm4+"','"+nm5+"','"+nm6+"','"+nm7+"','"+nm8+"','"+nm9+"','"+nm10+"','"+nm11+"','"+nm12+"','"+id+"','no')";
                //pw1.println(q2);
                ...
                if(x>0)
                {
                    ...
                    no1++;
                    String q3="update debit_id set id='"+no1+"'";
                    //pw1.println(q3);
                    int x1=stmt.executeUpdate(q3);
                     ...
                     if(x1>0)
                     {
                      ...
                      pw1.println("Your id&nbsp;&nbsp;"+id);
                        pw1.println("<br><a href=\"status_check_debit.html\">Check status for approval</a>");
